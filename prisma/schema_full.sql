...
CREATE TABLE "Festival" (
    ...
    "bannerUrl" TEXT,
    "galleryUrls" TEXT,
    "defaultStallPrice" REAL NOT NULL DEFAULT 35000.0,
    "mapDimensions" TEXT,
    ...
    "instagramUrl" TEXT,
    "decks" TEXT,
    "proposedArtistLineup" TEXT,
    "mapLocked" BOOLEAN NOT NULL DEFAULT false,
    "mapLayoutHistory" TEXT,
    "mediaHistory" TEXT,
...
CREATE TABLE "Stall" (
    ...
    "festivalName" TEXT NOT NULL DEFAULT '',
    ...
    "description" TEXT,
    "powerGrid" TEXT NOT NULL DEFAULT 'Standard (15A)',
